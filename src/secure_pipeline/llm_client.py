...
- Classification / Guard: `meta-llama/llama-prompt-guard-2-86m`
- Generative Chat: `llama-3.1-8b-instant`, `llama-3.3-70b-versatile`, `gemma2-9b-it`
- Fallbacks: OpenAI, Gemini, and Deterministic Stub
"""
...
class LLMClient:
    ...
    ----------
    model : Optional[str]
        Model identifier. Defaults to 'meta-llama/llama-prompt-guard-2-86m' or 'llama-3.1-8b-instant'.
    temperature : float
    ...
    def generate(
        ...
        """
        Generate response given conversational memory context, retrieved docs, and query.
        """
    ...
    def _is_guard_model(self) -> bool:
        """Check if model is a specialized Prompt Guard or classification model."""
        m = self._model.lower()
    ...
    def _build_system_prompt(
        ...
        return (
            ...
            "Quote specific figures, trial numbers, and facts where possible.\n\n"
    ...
    def _chat_completions_generate(
        ...
        if self._is_guard_model():
            ...
            try:
                # Send classification request to Groq prompt guard
                ...
                # Prompt guard returns safety classification. Combine with grounded doc facts:
        ...
        # Standard Generative Chat Models (e.g. llama-3.1-8b-instant, llama-3.3-70b-versatile, etc.)
    ...
    def _compose_rag_response(
        ...
        """Compose grounded RAG response incorporating guard check and retrieved facts."""
        if retrieved_docs:
            parts = []
